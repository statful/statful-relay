...
module.exports = {
    ...
    processMetricLine: function (config) {
            ...
            if (!cache.get(tenant)) {
                ...
                destination.client.indices.create({
                    ...
                    if (error
                        ...
                        // we should only trigger this error if the index ceration failed for some other reason.
        ...
        return function _processMetricLine(line) {
            ...
            createIndex(destination, metric_tenant, function () {
                indexMetric(metric_key, destination);
            });
        };
    },
