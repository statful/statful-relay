...
describe('Statful metrics are sent from clients', function () {
    ...
    it('should send a simple metric to Statful', function () {
    ...
    it('should send a collection of metrics to Statful', function () {
        mockTool.mockSimple('/tel/v2.0/metrics', 201);
    ...
    it('should send metrics from multiple requests to Statful', function () {
        mockTool.mockSimple('/tel/v2.0/metrics', 201);
